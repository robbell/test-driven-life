...
namespace TestDrivenLife.Tests
{
    [TestFixture]
    public class GridTest
    {
        ...
        [TestCase(30, 20, Result = 1)]
        [TestCase(31, 20, Result = 2)]
        [TestCase(32, 20, Result = 1)]
        [TestCase(50, 75, Result = 2)]
        [TestCase(50, 76, Result = 3)]
        [TestCase(50, 77, Result = 2)]
        [TestCase(51, 76, Result = 3)]
        [TestCase(149, 0, Result = 0)]
        [TestCase(75, 99, Result = 1)]
